...
'''
## 2. Second_backend_autotest_from_the_lecture, check_one_of_the_values_in_JSON_in_response_(name).
'''def test_part_of_response():
    response_get = requests.get(url = f'{URL}/pokemons', params = {"trainer_id" : TRAINER_ID})
    assert response_get.json()["data"][0]["name"] == 'scyther'
'''
## 3. Third_backend_autotest_from_the_lecture, parametrized_backend_autotest.
'''## Step 1,fixture.
